...
document.write('<link href="'+ scripturl.scriptpath+'stylesheets/mobile-hook.css" rel="stylesheet">');
}
...
document.write('<script type="text/javascript" src="'+ scripturl.scriptpath+'/javascripts/skrollr.min.js"><\/script>');
document.write('<script type="text/javascript" src="'+ scripturl.scriptpath+'/javascripts/skrollr.menu.js"><\/script>');
}
