...
<section class="blog alternate-bg2" style="margin-top:80px;" id="blog">
	<div class="container">
		...
		<div class="two-thirds column posts">
			...
			<div class="page-nav clearfix" style="margin-bottom:30px;">
			 ...
			 <span class="fl"><?php previous_post_link('<strong>%link</strong>','&laquo; Previous'); ?></span>
			 <span class="fr"><?php next_post_link('<strong>%link</strong>','Next &raquo;'); ?></span>
			</div>
	...
	<div class="one-third column">
		...
		<div class="heading">
		 <h5><?php _e('Portfolio Details','framework'); ?></h5>
		 </div>
