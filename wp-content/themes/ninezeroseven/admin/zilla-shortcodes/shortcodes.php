...
function social_code ($atts, $content = null ) {
	...
	if(!empty($twitter)){
		$links .= '<li><a class="hide-text twitter" href="'.esc_html($twitter).'">'. __('Twitter','framework') .'</a></li>';
	}

	if(!empty($facebook)){
		$links .= '<li><a class="hide-text facebook" href="'.esc_html($facebook).'">'. __('Facebook','framework') .'</a></li>';
	}
	if(!empty($google)){
		$links .= '<li><a class="hide-text google" href="'.esc_html($google).'">'. __('Google','framework') .'</a></li>';
	}
	if(!empty($flickr)){
		$links .= '<li><a class="hide-text flickr" href="'.esc_html($flickr).'">'. __('Flickr','framework') .'</a></li>';
	}
	if(!empty($linkedin)){
		$links .= '<li><a class="hide-text linkedin" href="'.esc_html($linkedin).'">'. __('LinkedIn','framework') .'</a></li>';
	}
	if(!empty($pinterest)){
		$links .= '<li><a class="hide-text pinterest" href="'.esc_html($pinterest).'">'. __('Pinterest','framework') .'</a></li>';
	}
	if(!empty($dribbble)){
		$links .= '<li><a class="hide-text dribbble" href="'.esc_html($dribbble).'">'. __('Dribbble','framework') .'</a></li>';
	}
	if(!empty($deviantart)){
		$links .= '<li><a class="hide-text deviantart" href="'.esc_html($deviantart).'">'. __('DeviantArt','framework') .'</a></li>';
	}

	if(!empty($youtube)){
		$links .= '<li><a class="hide-text youtube" href="'.esc_html($youtube).'">'. __('Youtube','framework') .'</a></li>';
	}

	if(!empty($vimeo)){
		$links .= '<li><a class="hide-text vimeo" href="'.esc_html($vimeo).'">'. __('Vimeo','framework') .'</a></li>';
	}

	if(!empty($instagram)){
		$links .= '<li><a class="hide-text instagram" href="'.esc_html($instagram).'">'. __('Instagram','framework') .'</a></li>';
	}

	if(!empty($email)){
		$links .= '<li><a class="hide-text email" href="mailto:'.esc_html($email).'">'. __('Email','framework') .'</a></li>';
	}

	if(!empty($soundcloud)){
		$links .= '<li><a class="hide-text soundcloud" href="'.esc_html($soundcloud).'">'. __('Soundcloud','framework') .'</a></li>';
	}

	if(!empty($behance)){
		$links .= '<li><a class="hide-text behance" href="'.esc_html($behance).'">'. __('Behance','framework') .'</a></li>';
	}

	if(!empty($ustream)){
		$links .= '<li><a class="hide-text ustream" href="'.esc_html($ustream).'">'. __('Ustream','framework') .'</a></li>';
	}

	if(!empty($rss)){
		$links .= '<li><a class="hide-text rss" href="'.esc_html($rss).'">'. __('rss','framework') .'</a></li>';
	}
