			...
			$video_link = get_post_meta(get_the_ID(), 'nzs_video_link', true);
       		...
       		if($video_link && !empty($video_link)){
	         	...
	         	if($video_url){
           		...
           		printf('<div class="featured-video"><div class="video"><iframe src="%1s" width="400" height="300" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div></div>',
           			esc_attr($video_url));
