...
?>
			<li class="four columns">
				...
				<div class="social">
					...
					if($team_twitter){
					?>
					<a class="hide-text twitter" href="<?php echo $team_twitter;?>">Twitter</a>
					<?php
					} 
					?>
					<?php
					if($team_facebook){
					?>
					<a class="hide-text facebook" href="<?php echo $team_facebook;?>">Facebook</a>
					<?php
					} 
					?>
					<?php
					if($team_google){
					?>
					<a class="hide-text google" href="<?php echo $team_google;?>">Google+</a>
					<?php
					} 
					?>
					<?php
					if($team_dribbble){
					?>
					<a class="hide-text dribbble" href="<?php echo $team_dribbble;?>">Dribbble</a>
					<?php
					} 
					?>
					<?php
					if($team_pinterest){
					?>
					<a class="hide-text pinterest" href="<?php echo $team_pinterest;?>">Pinterest</a>
					<?php
					} 
					?>
					<?php
					if($team_flickr){
					?>
					<a class="hide-text flickr" href="<?php echo $team_flickr;?>">Flickr</a>
					<?php
					} 
					?>
					<?php
					if($team_deviantart){
					?>
					<a class="hide-text deviantart" href="<?php echo $team_deviantart;?>">Deviantart</a>
					<?php
					} 
					?>
					<?php
					if($team_linkedin){
					?>
					<a class="hide-text linkedin" href="<?php echo $team_linkedin;?>">Linkedin</a>
					<?php
					} 
					?>
					...
					if($team_vimeo){
					?>
					<a class="hide-text vimeo" href="<?php echo $team_vimeo;?>">Vimeo</a>
					<?php
					} 
					?>
					...
					if($team_instagram){
					?>
					<a class="hide-text instagram" href="<?php echo $team_instagram;?>">Instagram</a>
					<?php
					} 
					?>
					...
					if($team_email){
					?>
					<a class="hide-text email" href="mailto:<?php echo $team_email;?>">Email</a>
					<?php
					} 
					?>
					...
					if($team_youtube){
					?>
					<a class="hide-text youtube" href="<?php echo $team_youtube;?>">Youtube</a>
					<?php
					} 
					?>
					...
					if($team_soundcloud){
					?>
					<a class="hide-text soundcloud" href="<?php echo $team_soundcloud;?>">Soundcloud</a>
					<?php
					} 
					?>
					...
					if($team_behance){
					?>
					<a class="hide-text behance" href="<?php echo $team_behance;?>">Behance</a>
					<?php
					} 
					?>
					...
					if($team_ustream){
					?>
					<a class="hide-text ustream" href="<?php echo $team_ustream;?>">Ustream</a>
					<?php
					} 
					?>
					...
					if($team_rss){
					?>
					<a class="hide-text rss" href="<?php echo $team_rss;?>">RSS</a>
					<?php
					} 
					?>
